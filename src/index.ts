/**
 * oh-my-qwencode - Multi-agent orchestration for Qwen Code
 *
 * This package provides:
 * - 30+ specialized agent prompts as Qwen Code slash commands
 * - 35+ workflow skills as SKILL.md files
 * - AGENTS.md orchestration brain
 * - MCP servers for state management, project memory, and notepad
 * - CLI tool (omq) for setup, diagnostics, and management
