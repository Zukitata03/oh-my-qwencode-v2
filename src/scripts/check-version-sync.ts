...
const explore = TOML.parse(readFileSync(join(root, 'crates', 'omq-explore', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const runtimeCore = TOML.parse(readFileSync(join(root, 'crates', 'omq-runtime-core', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const mux = TOML.parse(readFileSync(join(root, 'crates', 'omq-mux', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const runtime = TOML.parse(readFileSync(join(root, 'native', 'omq-runtime', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const sparkshell = TOML.parse(readFileSync(join(root, 'native', 'omq-sparkshell', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
...
if ((explore.package as Record<string, unknown>)?.version !== undefined && ((explore.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/omq-explore/Cargo.toml must use version.workspace = true');
}
if ((runtimeCore.package as Record<string, unknown>)?.version !== undefined && ((runtimeCore.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/omq-runtime-core/Cargo.toml must use version.workspace = true');
}
if ((mux.package as Record<string, unknown>)?.version !== undefined && ((mux.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/omq-mux/Cargo.toml must use version.workspace = true');
}
if ((runtime.package as Record<string, unknown>)?.version !== undefined && ((runtime.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('native/omq-runtime/Cargo.toml must use version.workspace = true');
}
if ((sparkshell.package as Record<string, unknown>)?.version !== undefined && ((sparkshell.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('native/omq-sparkshell/Cargo.toml must use version.workspace = true');
}
