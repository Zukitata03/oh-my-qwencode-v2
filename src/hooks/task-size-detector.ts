 ...
 * (mandatory enforcement). In OMQ, Qwen Code does not support pre-tool hooks, so this
 * module serves as:
 ...
 *   3. Future hook readiness — will be promoted to runtime enforcement when Qwen Code
 *      adds pre-hook support
 *
 * The actual gate enforcement in OMQ is advisory: AGENTS.md instructs the model to
