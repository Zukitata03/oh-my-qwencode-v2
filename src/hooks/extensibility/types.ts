...
export interface HookPluginOmqSessionState {
  session_id: string;
  started_at?: string;
  cwd?: string;
  pid?: number;
...
export interface HookPluginOmqHudState {
  last_turn_at?: string;
  turn_count?: number;
...
export interface HookPluginOmqNotifyFallbackState {
  pid?: number;
  parent_pid?: number;
  started_at?: string;
  cwd?: string;
...
export interface HookPluginOmqUpdateCheckState {
  last_checked_at?: string;
  last_seen_latest?: string;
  [key: string]: unknown;
}

export interface HookPluginOmqSdk {
  session: {
    read: () => Promise<HookPluginOmqSessionState | null>;
  };
  hud: {
    read: () => Promise<HookPluginOmqHudState | null>;
  };
  notifyFallback: {
    read: () => Promise<HookPluginOmqNotifyFallbackState | null>;
  };
  updateCheck: {
    read: () => Promise<HookPluginOmqUpdateCheckState | null>;
  };
}
