/**
 * Pipeline Orchestrator for oh-my-qwencode
 *
 * Sequences configurable stages (RALPLAN -> teams -> ralph verification)
 * and persists state through the ModeState system.
 *
 * Mirrors OMC #1130 pipeline design with OMQ-specific adaptations:
 * - Execution backend is always teams (Qwen Code workers)
 ...
 * This is the canonical OMQ pipeline matching the OMC #1130 design.
 */
