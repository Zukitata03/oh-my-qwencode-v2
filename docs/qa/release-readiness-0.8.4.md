...
| Version smoke | `node bin/omq.js version` | PASS (`oh-my-qwencode v0.8.4`) |
| Doctor smoke | `node bin/omq.js doctor` | PASS (`9 passed, 0 warnings, 0 failed`) |
...
- This is a focused patch release centered on `omq setup` refresh behavior and managed model upgrade prompting.
