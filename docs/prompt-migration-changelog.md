...
- Goal: document the prior XML-to-Markdown migration while reaffirming that prompt files remain the canonical XML-tagged subagent role surfaces for OMQ.
...
- Important current-state clarification: although the prompt text is now Markdown-first, each file in `prompts/*.md` is still the canonical XML-tagged subagent role surface consumed by OMQ install/generation flows.
...
These files are the instruction root that OMQ expects Qwen Code to follow across a workspace.
Changes here are primarily about aligning instructions with Qwen Code tool contracts.

### Key Deltas

- Updated child-agent delegation guidance to reflect the Qwen Code `spawn_agent` API:
...
- Aligning config guidance with Qwen Code-first paths (`~/.qwen/…`, `QWEN_HOME`)
- Preserving each skill's contract/intent while improving correctness for Qwen Code users

### Behavior Notes

- These are documentation / instruction changes; they do not directly change runtime logic.
- One meaningful correction was made: the "agent teams" enablement guidance in `skills/omq-setup/SKILL.md` was updated to enable Qwen Code features via `~/.qwen/config.toml` rather than legacy `settings.json` env vars.

### Per-File Matrix

| Skill File | Added | Removed | Structural Highlights | Behavior Delta |
|---|---:|---:|---|---|
| `skills/analyze/SKILL.md` | 1 | 1 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/autopilot/SKILL.md` | 11 | 16 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/code-review/SKILL.md` | 1 | 1 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
...
| `skills/doctor/SKILL.md` | 47 | 45 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/ecomode/SKILL.md` | 1 | 1 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/frontend-ui-ux/SKILL.md` | 2 | 2 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/help/SKILL.md` | 1 | 1 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/learner/SKILL.md` | 5 | 5 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/omq-setup/SKILL.md` | 144 | 156 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/plan/SKILL.md` | 1 | 1 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/project-session-manager/SKILL.md` | 5 | 5 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/release/SKILL.md` | 3 | 3 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/research/SKILL.md` | 10 | 15 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/security-review/SKILL.md` | 1 | 1 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/skill/SKILL.md` | 20 | 20 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/tdd/SKILL.md` | 1 | 1 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/ultrapilot/SKILL.md` | 11 | 16 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/writer-memory/SKILL.md` | 1 | 1 | Qwen Code path/terminology normalization; examples updated to Qwen Code-first conventions. | No direct runtime behavior change; instruction correctness improved. |

### Hotspots Worth Reviewing

- `skills/omq-setup/SKILL.md`: largest edit surface; includes team enablement guidance (`~/.qwen/config.toml` `[features]` flags) and teammate display preference storage (`~/.qwen/.omq-config.json`).
