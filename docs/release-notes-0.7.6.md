...
- `refactor(mcp): extract omq_run_team_* to dedicated team-server.ts` (#431)
...
- Skills canonical OMQ path normalization.
...
| `node bin/omq.js --help` | 0 | CLI usage rendered |
| `node bin/omq.js doctor` | 0 | `Results: 9 passed, 0 warnings, 0 failed` |
| `node bin/omq.js version` | 0 | `oh-my-qwencode v0.7.6` |
| `node bin/omq.js status` | 0 | mode status rendered |
| `node bin/omq.js setup --dry-run` | 0 | dry-run setup completed |
| `node bin/omq.js cancel` | 0 | cancel command completed |
...
- `2026-03-01 3f6b3fd refactor(mcp): extract omq_run_team_* to dedicated team-server.ts (#431)`
...
- `2026-03-02 e0c5974 fix(skills): normalize forked OMC references to OMQ canonical paths`
