...
1. Reads token tracking from `~/.omq/state/token-tracking.jsonl`
2. Reads session history from `.omq/state/session-history.json`
...
- "Set defaultExecutionMode in /omq-setup for consistent behavior"
